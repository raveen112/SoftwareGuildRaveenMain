...
function loadContacts() {
    ...
    $.ajax({
        ...
        // The success function will retrieve records from contactArray as its parameter.
        ...
        // We will use this function to generate error messages that will display in the #errorMessages 
        error: function () {
            $('#errorMessages')
                .append($('<li>')
